...
## First Step after pulling

1. create an .env file and add the followinig
   1. JWT_SECRET="SECRET_KEY"
   2. DATABASE_URL="postgresql://DB_USER:DB_PASSWORD@localhost:5434/DB_NAME?schema=public"
